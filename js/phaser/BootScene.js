...
export class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet('bartender_walk', 'assets/sprites/bartender_walk.png', { frameWidth: 192, frameHeight: 288 });
    this.load.spritesheet('guest_drink', 'assets/sprites/guest_drink.png', { frameWidth: 144, frameHeight: 120 });
    ...
    for (const id of GUEST_APPEARANCE_IDS) {
      ...
      this.load.spritesheet(`guest_walk_${id}`, `assets/sprites/guest_walk_${id}.png`, { frameWidth: 144, frameHeight: 192 });
    }
